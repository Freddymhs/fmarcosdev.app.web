# FASE 8 — UX Polish & Frontend Quality (Semi Senior Level)
...
### 8.0 — Social page no implementada
...
### 8.4 — Error/loading states faltantes en 4 páginas
...
### 8.5 — Cypress tests con selectores inválidos
...
### 8.7 — Scroll-to-top automático en cambio de ruta
...
### 8.8 — Accesibilidad: elementos clickeables sin role
...
### 8.9 — Retry logic en useResumeData
...
### 8.10 — Sin data-testid en elementos críticos
