...
export const TECH_MODULAR_ARCHITECTURE_BACKEND = "Modular Architecture";
export const TECH_ERROR_HANDLING_MIDDLEWARE_BACKEND =
  "Error Handling Middleware";
export const TECH_VALIDATION_PIPES_BACKEND = "Validation Pipes";
export const TECH_THREAD_MANAGEMENT_BACKEND = "Thread Management";
export const TECH_HEALTH_MONITORING_BACKEND = "Health Monitoring";
export const TECH_PERFORMANCE_OPTIMIZATION_BACKEND = "Performance Optimization";
...
export const TECH_NESTJS_SCRAPER_ARCHITECTURE_BACKEND =
  "NestJS Scraper Architecture";
export const TECH_PROXY_ROTATION_IPROYAL_BACKEND = "Proxy Rotation (IPRoyal)";
export const TECH_CONCURRENT_BROWSER_MANAGEMENT_BACKEND =
  "Concurrent Browser Management";
export const TECH_SCREENSHOT_AUTOMATION_BACKEND = "Screenshot Automation";
export const TECH_NEXUS_BACKEND = "Nexus";
export const TECH_REDIS_BACKEND = "Redis";
export const TECH_AWS_SQS_BACKEND = "AWS SQS";
export const TECH_AWS_S3_BACKEND = "AWS S3";
export const TECH_REDIS_PUB_SUB_BACKEND = "Redis Pub/Sub";
export const TECH_API_GATEWAY_BACKEND = "API Gateway";
export const TECH_AWS_SNS_SQS_BACKEND = "AWS SNS/SQS";
export const TECH_CLEAN_ARCHITECTURE_BACKEND = "Clean Architecture";
export const TECH_ROLE_BASED_ACCESS_CONTROL_BACKEND =
  "Role-based Access Control";
export const TECH_HARDWARE_INTEGRATION_BACKEND = "Hardware Integration";
export const TECH_PDF_CSV_GENERATION_BACKEND = "PDF/CSV Generation";
export const TECH_CIRCUIT_BREAKER_BACKEND = "Circuit Breaker";
export const TECH_ASYNCHRONOUS_PROGRAMMING_BACKEND = "Asynchronous Programming";
export const TECH_REACT_18 = "React 18";
export const TECH_ANT_DESIGN_BACKEND = "Ant Design";
export const TECH_FEATURE_FLAGS_BACKEND = "Feature Flags";
export const TECH_UI_UX_OPTIMIZATION_BACKEND = "UI/UX Optimization";
export const TECH_SEO_OPTIMIZATION_BACKEND = "SEO Optimization";
export const TECH_MOBILE_SCANNER_BACKEND = "Mobile Scanner";
export const TECH_BLUETOOTH_PRINT_ESC_POS_BACKEND = "Bluetooth Print ESC/POS";
export const TECH_DART_BACKEND = "Dart";
export const TECH_CROSS_PLATFORM_BACKEND = "Cross-platform";
export const TECH_PWA_BACKEND = "PWA";
...
export const TECH_REAL_TIME_INVENTORY_MANAGEMENT_BACKEND =
  "Real-time Inventory Management";
export const TECH_SERVERLESS_ARCHITECTURE_BACKEND = "Serverless Architecture";
export const TECH_AWS_FREE_TIER_BACKEND = "AWS Free Tier";
export const TECH_AWS_LAMBDA_BACKEND = "AWS Lambda";
export const TECH_AWS_SES_BACKEND = "AWS SES";
export const TECH_AWS_EC2_LAMBDAS_DYNAMODB_BACKEND =
  "AWS (EC2, Lambdas, DynamoDB)";
export const TECH_COMPUTER_VISION_BACKEND = "Computer Vision";
export const TECH_CONVERSATIONAL_AI_BACKEND = "Conversational AI";
export const TECH_IMAGE_ANALYSIS_BACKEND = "Image Analysis";
export const TECH_HUMAN_BEHAVIOR_SIMULATION_BACKEND =
  "Human Behavior Simulation";
export const TECH_ANTI_DETECTION_TECHNIQUES_BACKEND =
  "Anti-Detection Techniques";
export const TECH_TWILIO_API_BACKEND = "Twilio API";
export const TECH_WHATSAPP_BUSINESS_API_BACKEND = "WhatsApp Business API";
export const TECH_WHATSAPP_INTEGRATION_BACKEND = "WhatsApp Integration";
export const TECH_GOOGLE_SHEETS_API_BACKEND = "Google Sheets API";
export const TECH_GOOGLE_OAUTH2_BACKEND = "Google OAuth2";
export const TECH_AXIOS_HTTP_CLIENT_BACKEND = "Axios HTTP Client";
export const TECH_BROWSER_POOL_MANAGEMENT_BACKEND = "Browser Pool Management";
export const TECH_SHADOW_DOM_MANIPULATION_BACKEND = "Shadow DOM Manipulation";
export const TECH_THREAD_MANAGEMENT_FRONTEND = "Thread Management";
export const TECH_HEALTH_MONITORING_FRONTEND = "Health Monitoring";
export const TECH_CONNECTION_POOLING_BACKEND = "Connection Pooling";
export const TECH_VALIDATION_PIPES_FRONTEND = "Validation Pipes";
export const TECH_RATE_LIMITING_BACKEND = "Rate Limiting";
export const TECH_ERROR_HANDLING_MIDDLEWARE_FRONTEND =
  "Error Handling Middleware";
export const TECH_MODULAR_ARCHITECTURE_FRONTEND = "Modular Architecture";
export const TECH_DATABASE_DESIGN_BACKEND = "Database Design";
export const TECH_DEPENDENCY_INJECTION_BACKEND = "Dependency Injection";
export const TECH_PERFORMANCE_OPTIMIZATION_FRONTEND =
  "Performance Optimization";
export const TECH_STYLED_COMPONENTS_FRONTEND = "Styled Components";
export const TECH_REACT_PARALLAX_FRONTEND = "React Parallax";
export const TECH_REACT_HELMET_FRONTEND = "React Helmet";
export const TECH_REACT_I18NEXT_FRONTEND = "React i18next";
export const TECH_GATSBY_PLUGINS_FRONTEND = "Gatsby Plugins";
export const TECH_BOOTSTRAP_FRONTEND = "Bootstrap";
export const TECH_CONTEXT_API_FRONTEND = "Context API";
export const TECH_USEREDUCER_FRONTEND = "useReducer";
export const TECH_REACT_ROUTER_DOM_FRONTEND = "React Router DOM";
export const TECH_REACT_NATIVE_MOBILE = "react-native";
export const TECH_DART_MOBILE = "Dart";
export const TECH_CROSS_PLATFORM_MOBILE = "Cross-platform";
export const TECH_MOBILE_SCANNER_MOBILE = "Mobile Scanner";
export const TECH_BLUETOOTH_PRINT_ESC_POS_MOBILE = "Bluetooth Print ESC/POS";
export const TECH_PWA_MOBILE = "PWA";
